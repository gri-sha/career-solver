...
export default function SelfEvalCard({ form }: DataCardProps) {
    return (
        <Card className={selfEvalCardStyles.card}>
            ...
            <CardContent>
                <Form {...form}>
                    <div className={selfEvalCardStyles.container}>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className={selfEvalCardStyles.item}>
                                    ...
                                    <FormControl>
                                        <Slider
                                            className={selfEvalCardStyles.slider}
                                            min={0}
                                            max={11}
                                            value={[field.value]}
                                    ...
                                    <Label className={selfEvalCardStyles.sliderLabel}>
                                        {field.value === 11 ? "10+" : field.value}
                                    </Label>
